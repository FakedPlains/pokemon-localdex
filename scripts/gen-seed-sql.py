...
with open(OUT, "w", encoding="utf-8") as f:
    ...
    f.write("-- Drop and recreate tables (faster than DELETE for full reseed)\n")
    f.write("DROP TABLE IF EXISTS move_battle_effects;\n")
    f.write("DROP TABLE IF EXISTS item_battle_effects;\n")
    f.write("DROP TABLE IF EXISTS ability_battle_effects;\n")
    f.write("DROP TABLE IF EXISTS move_flags;\n\n")
    # CREATE TABLE: move_flags
    f.write("CREATE TABLE IF NOT EXISTS move_flags (\n")
    f.write("  id INTEGER PRIMARY KEY AUTOINCREMENT,\n")
    f.write("  move_id INTEGER NOT NULL REFERENCES moves(id) ON DELETE CASCADE,\n")
    f.write("  flag INTEGER NOT NULL,\n")
    f.write("  UNIQUE (move_id, flag)\n")
    f.write(");\n\n")
    # CREATE TABLE: ability_battle_effects
    f.write("CREATE TABLE IF NOT EXISTS ability_battle_effects (\n")
    f.write("  id INTEGER PRIMARY KEY AUTOINCREMENT,\n")
    f.write("  ability_id INTEGER NOT NULL REFERENCES abilities(id) ON DELETE CASCADE,\n")
    f.write("  effect_type INTEGER NOT NULL,\n")
    f.write("  trigger INTEGER NOT NULL DEFAULT 1,\n")
    f.write("  target INTEGER NOT NULL DEFAULT 1,\n")
    f.write("  modifier_type INTEGER NOT NULL,\n")
    f.write("  modifier_value REAL,\n")
    f.write("  affected_stat INTEGER,\n")
    f.write("  affected_type INTEGER,\n")
    f.write("  affected_move_flag INTEGER,\n")
    f.write("  affected_move_category INTEGER,\n")
    f.write("  params TEXT,\n")
    f.write("  generation_start INTEGER NOT NULL DEFAULT 1,\n")
    f.write("  generation_end INTEGER,\n")
    f.write("  priority INTEGER NOT NULL DEFAULT 0,\n")
    f.write("  note TEXT\n")
    f.write(");\n\n")
    # CREATE TABLE: item_battle_effects
    f.write("CREATE TABLE IF NOT EXISTS item_battle_effects (\n")
    f.write("  id INTEGER PRIMARY KEY AUTOINCREMENT,\n")
    f.write("  item_id INTEGER NOT NULL REFERENCES items(id) ON DELETE CASCADE,\n")
    f.write("  effect_type INTEGER NOT NULL,\n")
    f.write("  trigger INTEGER NOT NULL DEFAULT 1,\n")
    f.write("  target INTEGER NOT NULL DEFAULT 1,\n")
    f.write("  modifier_type INTEGER NOT NULL,\n")
    ...
    f.write("  affected_move_category INTEGER,\n")
    f.write("  params TEXT,\n")
    f.write("  consumable INTEGER NOT NULL DEFAULT 0,\n")
    f.write("  species_restriction TEXT,\n")
    f.write("  generation_start INTEGER NOT NULL DEFAULT 1,\n")
    f.write("  generation_end INTEGER,\n")
    f.write("  priority INTEGER NOT NULL DEFAULT 0,\n")
    f.write("  note TEXT\n")
    f.write(");\n\n")
    # CREATE TABLE: move_battle_effects
    f.write("CREATE TABLE IF NOT EXISTS move_battle_effects (\n")
    f.write("  id INTEGER PRIMARY KEY AUTOINCREMENT,\n")
    f.write("  move_id INTEGER NOT NULL REFERENCES moves(id) ON DELETE CASCADE,\n")
    f.write("  effect_type INTEGER NOT NULL,\n")
    f.write("  trigger INTEGER NOT NULL DEFAULT 7,\n")
    f.write("  target INTEGER NOT NULL DEFAULT 2,\n")
    f.write("  modifier_type INTEGER NOT NULL,\n")
    f.write("  modifier_value REAL,\n")
    f.write("  affected_stat INTEGER,\n")
    f.write("  affected_type INTEGER,\n")
    ...
    f.write(");\n\n")
    # Recreate indexes
    f.write("-- Recreate indexes\n")
    f.write("CREATE INDEX IF NOT EXISTS idx_move_flags_move ON move_flags(move_id);\n")
    f.write("CREATE INDEX IF NOT EXISTS idx_move_flags_flag ON move_flags(flag);\n")
    f.write("CREATE INDEX IF NOT EXISTS idx_abe_ability ON ability_battle_effects(ability_id);\n")
    f.write("CREATE INDEX IF NOT EXISTS idx_abe_effect_type ON ability_battle_effects(effect_type);\n")
    f.write("CREATE INDEX IF NOT EXISTS idx_abe_trigger ON ability_battle_effects(trigger);\n")
    f.write("CREATE INDEX IF NOT EXISTS idx_ibe_item ON item_battle_effects(item_id);\n")
    f.write("CREATE INDEX IF NOT EXISTS idx_ibe_effect_type ON item_battle_effects(effect_type);\n")
    f.write("CREATE INDEX IF NOT EXISTS idx_mbe_move ON move_battle_effects(move_id);\n")
    f.write("CREATE INDEX IF NOT EXISTS idx_mbe_effect_type ON move_battle_effects(effect_type);\n\n")
