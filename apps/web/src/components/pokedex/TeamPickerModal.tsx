...
import type { Team } from "../../utils/teamStorage";
import { getTeams, saveTeam } from "../../utils/teamStorage";
...
/* ─── Team Picker Modal ─── */
export default function TeamPickerModal({ onSelect, onClose }: TeamPickerModalProps) {
