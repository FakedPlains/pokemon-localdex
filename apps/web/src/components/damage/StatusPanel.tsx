...
export interface StatusPanelProps {
  ...
  toxicCounter: number;
  setToxicCounter: Dispatch<SetStateAction<number>>;
  stealthRock: boolean;
  setStealthRock: Dispatch<SetStateAction<boolean>>;
  spikes: number;
  setSpikes: Dispatch<SetStateAction<number>>;
  steelsurge: boolean;
  setSteelsurge: Dispatch<SetStateAction<boolean>>;
  reflect: boolean;
  setReflect: Dispatch<SetStateAction<boolean>>;
  lightScreen: boolean;
  setLightScreen: Dispatch<SetStateAction<boolean>>;
  auroraVeil: boolean;
  setAuroraVeil: Dispatch<SetStateAction<boolean>>;
  protect: boolean;
  setProtect: Dispatch<SetStateAction<boolean>>;
  helpingHand: boolean;
  setHelpingHand: Dispatch<SetStateAction<boolean>>;
  tailwind: boolean;
  setTailwind: Dispatch<SetStateAction<boolean>>;
  friendGuard: boolean;
  setFriendGuard: Dispatch<SetStateAction<boolean>>;
  switchingOut: boolean;
  setSwitchingOut: Dispatch<SetStateAction<boolean>>;
  seeded: boolean;
  setSeeded: Dispatch<SetStateAction<boolean>>;
  saltCured: boolean;
  setSaltCured: Dispatch<SetStateAction<boolean>>;
  foresight: boolean;
  setForesight: Dispatch<SetStateAction<boolean>>;
  flowerGift: boolean;
  setFlowerGift: Dispatch<SetStateAction<boolean>>;
  powerTrick: boolean;
  setPowerTrick: Dispatch<SetStateAction<boolean>>;
  steelySpirit: boolean;
  setSteelySpirit: Dispatch<SetStateAction<boolean>>;
  battery: boolean;
  setBattery: Dispatch<SetStateAction<boolean>>;
  powerSpot: boolean;
  setPowerSpot: Dispatch<SetStateAction<boolean>>;
  isDynamaxed: boolean;
  setIsDynamaxed: Dispatch<SetStateAction<boolean>>;
  alliesFainted: number;
  setAlliesFainted: Dispatch<SetStateAction<number>>;
...
export default function StatusPanel({
  label, side, status, setStatus, toxicCounter, setToxicCounter,
