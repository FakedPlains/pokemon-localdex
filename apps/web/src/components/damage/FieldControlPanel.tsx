import type { FieldKey, FieldState } from "./useFieldState";

export interface FieldControlPanelProps {
  field: FieldState;
  setField: (key: FieldKey, value: FieldState[FieldKey]) => void;
  toggleField: (key: FieldKey) => void;
}

const WEATHER_OPTIONS: Array<{ v: string; l: string }> = [
  { v: "sun", l: "晴天" },
...
const TERRAIN_OPTIONS: Array<{ v: string; l: string }> = [
  { v: "electric", l: "电气" },
  { v: "grassy", l: "青草" },
  { v: "misty", l: "薄雾" },
  { v: "psychic", l: "精神" },
...
export default function FieldControlPanel({ field, setField, toggleField }: FieldControlPanelProps) {
  return (
