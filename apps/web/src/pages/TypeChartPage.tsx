...
export interface TypeChartPageProps {}
...
export default function TypeChartPage(_props: TypeChartPageProps) {
  const [highlightAtk, setHighlightAtk] = useState<number | null>(null);
  const [highlightDef, setHighlightDef] = useState<number | null>(null);
